...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        temp18.Animation = Fuse.Platform.StatusBarAnimation.Slide;
        temp19.Color = float4(1f, 1f, 1f, 0f);
        router.Name = __selector0;
        temp20.DefaultPath = "SignIn";
        temp20.Templates.Add(SignIn);
        temp20.Templates.Add(SignUp);
        temp20.Templates.Add(Main);
        temp21.Code = "\n\tmodule.exports = {\n\t\topenSignInPage: function() { router.goBack(); },\n\t\topenSignUpPage: function() { router.push(\"SignUp\"); },\n\t\topenMainPage: function() { router.goto(\"Main\"); }\n\t};\n\t";
        temp21.LineNumber = 54;
